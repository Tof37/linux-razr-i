...
/**
 * intel_msic_store_refrenced_table - store data to
 * refrenced table from preconfigured battery data
 */
			       ...
			       size_t count)
{
	...
	/* If same value is given, no need to do anything. Not an error */
