				...
				PVRSRV_DEV_POWER_STATE	eCurrentPowerState)
{
	...
	if ((eNewPowerState != eCurrentPowerState) &&
		...
		PNW_TOPAZ_NEW_PMSTATE(gpDrmDevice, topaz_priv,
		 ...
		 *        6f78a5b61be55d222fa3880008d2198efa7713bf by Austin,
		 *        Yuan
		 *        1) Remove map_topaz_reg/unmap_topaz_reg for
		 *        suspend/resume no map/umap topaz register
		 *        is needed */
				 ...
				 PVRSRV_DEV_POWER_STATE	eCurrentPowerState)
{
	...
	if ((eNewPowerState != eCurrentPowerState) &&
		 ...
		 *        Yuan
		 *        1) Remove map_topaz_reg/unmap_topaz_reg for
		 *        suspend/resume no map/umap topaz register is
		 *        needed */
